...
for r in reader:
    try:
        ...
        continue
    data.append((r["case"], n, broken, planner_status, planner_time, bf_status, bf_time))
...
max_time = max([t for t in planner_times + bf_times if t == t] or [0.0])
min_time = min([t for t in planner_times + bf_times if t == t] or [0.0])
